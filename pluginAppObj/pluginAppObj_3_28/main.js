function youtubegallery_pluginAppObj_3_28() {
    ...
    function loadHtml() {
        if(!preview){      
            ...
            var links = "https://youtu.be/3iR0mJQuiT0?si=yF7vE5wvk6B-nqQX||https://youtu.be/jmoQ55Y1FfA?si=HJQrwGhiooiPQF1W||https://youtu.be/E16hSlUGES4?si=1kJmCDziMYrwHYaW||||";
    ...
    function loadYouTubeGallery() {
        pluginAppObj_3_28YouTubeGallery = new Swiper('#pluginAppObj_3_28 .swiper-container.main', {
        ...
        nextButton: '#pluginAppObj_3_28 .swiper-button-next',
        prevButton: '#pluginAppObj_3_28 .swiper-button-prev',
        paginationClickable: true,
        pagination: '#pluginAppObj_3_28 .swiper-pagination',
