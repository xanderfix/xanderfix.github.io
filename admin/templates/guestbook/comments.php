...
?>
    ...
    <tr class="no-phone comment <?php echo $cssClass ?>">
        ...
        <td class="text-small border-bottom border-mute-light">
            <?php 
                if ($showObjectTitle) {
                    echo "<div class=\"margin-bottom-2 text-semibold\">" . l10n("cmn_subject") . " " . $comment['objectnumber'] . " - " . $comment['pagetitle'] . "</div>";
                }
            ?>
    ...
    <tr class="no-tablet no-desktop comment <?php echo $cssClass ?>">
        <td colspan="4">
            ...
            <div class="margin-bottom-2 clearfix">
                <?php 
                    if ($showObjectTitle) {
                        echo "<div class=\"margin-bottom text-semibold\">" . l10n("cmn_subject") . " " . $comment['objectnumber'] . " - " . $comment['pagetitle'] . "</div>";
                    }
                ?>
                <?php echo "<span class=\"body\">" . $comment['body'] . "</span>" ?>
            </div>
