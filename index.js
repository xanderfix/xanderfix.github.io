...
function change() {
    ...
    if (time == 4) {
         document.getElementById("WNdate").innerHTML = "9/28/2015";
         document.getElementById("WNa").href = "How-to-Play-Zeldas-Rescue.html";
         document.getElementById("WNimg").src = "images/Zelda's Rescue.jpg";
         document.getElementById("WNp").innerHTML = "How to Play Zelda's Rescue";
         time = -1;
    }
    time+=1;
    }, 4444)
