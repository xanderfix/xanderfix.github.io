...
<?php
    ...
    $links = "";
    $posturl = $baseposturlcategory . $comment['idCategory'] . $baseposturlproduct . $comment['product'] . "&";
...
?>
    ...
    <tr class="no-phone comment <?php echo $cssClass ?>">
        ...
        <td class="text-small border-bottom border-mute-light">
            <?php 
                if ($showObjectTitle) {
                    echo "<div class=\"margin-bottom text-semibold\">" . $comment['title'] . "</div>";
                    echo "<div class=\"margin-bottom-2\">" . $comment['category'] . "</div>";
                }
            ?>
            <?php echo "<span class=\"body\">" . $comment['body'] . "</span>" ?>
        </td>
        <td class="border-bottom border-right border-mute-light padding-left-10-child padding-bottom-10-child text-right"><?php echo $links ?></td>
    </tr>
        ...
        <td colspan="4">
            ...
            <div class="margin-bottom-2 clearfix">
                <?php 
                    if ($showObjectTitle) {
                        echo "<div class=\"margin-bottom text-semibold\">" . $comment['title'] . "</div>";
                        echo "<div class=\"margin-bottom\">" . $comment['category'] . "</div>";
                    }
                ?>
                <?php echo "<span class=\"body\">" . $comment['body'] . "</span>" ?>
            </div>
